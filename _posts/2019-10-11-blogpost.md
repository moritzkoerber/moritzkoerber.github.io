---
layout: post
title: "How to apply different preprocessing steps in a pipeline only to specific features"
date: "11 October 2019"
categories: [python, tutorial]
tags: [python, pipeline, preprocessing, scikit-learn]
---

# How to apply different preprocessing steps in a pipeline only to specific features
...
preprocessor = ColumnTransformer(
    [
        ('imputer', SimpleImputer(strategy = 'constant', fill_value = 'missing'), ['pclass', 'sex', 'embarked']),
        ('onehot', OneHotEncoder(), ['pclass', 'sex', 'embarked']),
        ('imputer', SimpleImputer(strategy = 'median'), ['age', 'sibsp', 'parch', 'fare']),
