...
<figure style="width: 33%;  margin: 0 auto;">
...
<span style="font-size:13px;">Github repo of the package: [https://github.com/ResidentMario/missingno](https://github.com/ResidentMario/missingno)</span>

<span class = "reference" style="font-size:13px"><sup>1</sup> Bilogur, A. (2018). Missingno: a missing data visualization suite. *Journal of Open Source Software*, *3*(22), 547. [https://doi.org/10.21105/joss.00547](https://doi.org/10.21105/joss.00547)</span>
